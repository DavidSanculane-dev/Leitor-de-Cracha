...
{
    public partial class HelloCardForm : Form
    {
        ...
        public HelloCardForm()
        {
            ...
            this.Text = "Leitor de Crachá ver.1.0.0 by David Sanculane";
            lblInsiraCard.Text = SMARTCARDAPI.ApiVersionInfo;
        }
        ...
        public void TerminalFoundEvent(object aSender, CardTerminalEventArgs aEventArgs)
        {
            ...
            else
            {
                if (CardTerminalManager.Singleton.StartedUp)
                {
                    ...
                    this.lblInsiraCard.Text = "Insert card ...";
        ...
        public void TerminalLostEvent(object aSender, CardTerminalEventArgs aEventArgs)
        {
            ...
            else
            {
                if (CardTerminalManager.Singleton.StartedUp)
                {
                    ...
                    {
                        this.lblInsiraCard.Text = "Connect reader ...";
        ...
        public void AccessCard(CardTerminalSlot aCardSlot)
        {
            ...
            if (nActivationResult != CardActivationResult.Success)
            {
                ...
                switch (nActivationResult)
                {
                    case CardActivationResult.NoCard:
                        lblInsiraCard.Text = readerName + ": Please insert card ...";
                        break;
                    case CardActivationResult.UnresponsiveCard:
                        lblInsiraCard.Text = readerName + ": Unresponsive card.";
                        break;
                    case CardActivationResult.InUse:
                        lblInsiraCard.Text = readerName + ": Card in use";
                        break;
                    default:
                        lblInsiraCard.Text = readerName + ": Can't power up card!";
                        break;
                }
                return;
            }
            lblInsiraCard.Text = aCardSlot.CardTerminalName + ": Found card";
            ...
            catch (Exception x)
            {
                ...
                lblInsiraCard.Text = "Card access error";
            }
            finally
            {
        ...
        {
            lblInsiraCard.Text = text;
            lblInsiraCard.Update();
        }
        ...
        void InitializeComponent1()
        {
            ...
            this.m_aCopyrightLabel.Size = new System.Drawing.Size(232, 16);
            this.m_aCopyrightLabel.TabIndex = 0;
            this.m_aCopyrightLabel.Text = "Copyright 2020 David Sanculane";
            // 
            // MainTextBox
            // 
            this.txtMainBox.Location = new System.Drawing.Point(15, 43);
            this.txtMainBox.Name = "txtMainBox";
            this.txtMainBox.ReadOnly = true;
            this.txtMainBox.Size = new System.Drawing.Size(500, 336);
            this.txtMainBox.TabIndex = 6;
            ...
            // m_aPromptLabel
            // 
            this.lblInsiraCard.Font = new System.Drawing.Font("Trebuchet MS", 12F, ((System.Drawing.FontStyle)((System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Italic))), System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lblInsiraCard.Location = new System.Drawing.Point(12, 18);
            this.lblInsiraCard.Name = "lblInsiraCard";
            this.lblInsiraCard.Size = new System.Drawing.Size(416, 34);
            this.lblInsiraCard.TabIndex = 2;
            this.lblInsiraCard.Text = "Insert card ...";
            // 
            // HelloCardForm
            // 
            ...
            this.Text = "Leitor de Crachá v.1.0.0 - card detection with SmartCard-API";
        ...
        private void txtMainBox_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            txtMainBox.AppendText(text + "\n");
            txtMainBox.ScrollToCaret();
            txtMainBox.Refresh();
        }
        ...
        private void HelloCardForm_Load_1(object sender, EventArgs e)
        {
